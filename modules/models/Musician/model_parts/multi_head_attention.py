...
import torch 
# Modules
from modules.models.Musician.model_parts.attention_head import Head
...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.config.asserts: assert out.shape == (B, S, self.config.d_head_size * self.config.num_heads )
